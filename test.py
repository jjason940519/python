...
def test():
    ...
    while True:
        ...
        if CMD == "s":
            while MOTOR1.data.q >= MOTOR1.inital_position_check + 0.33*6.33 and MOTOR4.data.q  <= MOTOR4.inital_position_check  :
            ...
            time.sleep(0.01)
            for i in range(36):                        
                unitree.position_force_velocity_cmd(motor_number = 1,kp = i,kd = 0.12, position = MOTOR1.inital_position_check + 0.33*6.33)
                unitree2.position_force_velocity_cmd(motor_number = 4 ,kp = i,kd = 0.12, position = MOTOR4.inital_position_check - 0.33*6.33)
                time.sleep(0.1)
            while MOTOR2.data.q >= MOTOR2.inital_position_check + 0.33*6.33*1.6 and MOTOR5.data.q  <= MOTOR5.inital_position_check - 0.33*6.33*1.6:
            ...
            time.sleep(0.01)
            for i in range(36):                        
                unitree.position_force_velocity_cmd(motor_number = 2,kp = i,kd = 0.15, position = MOTOR2.inital_position_check + 0.6*6.33*1.6)
                unitree2.position_force_velocity_cmd(motor_number = 5 ,kp = i,kd = 0.15, position = MOTOR5.inital_position_check - 0.6*6.33*1.6)
                time.sleep(0.1)
        
            while True:
                pass
        elif CMD == "i":
            unitree.position_force_velocity_cmd(motor_number = 1,kp = 0,kd = 0, position = 0 ,torque = 0, velocity = 0.0, check_flag = False)
            unitree2.position_force_velocity_cmd(motor_number = 4 ,kp = 0,kd = 0, position = 0 ,torque = 0, velocity= 0.0, check_flag = False)
            if MOTOR1.data.q >= MOTOR1.inital_position_check and MOTOR4.data.q <= MOTOR4.inital_position_check:
                while MOTOR1.data.q >= MOTOR1.inital_position_check and MOTOR4.data.q  <= MOTOR4.inital_position_check:
                    unitree.position_force_velocity_cmd(motor_number = 1,kp = 0,kd = 0.1, position = 0 ,torque = 0, velocity = -0.01, check_flag = False)
                    unitree2.position_force_velocity_cmd(motor_number = 4 ,kp = 0,kd = 0.1, position = 0 ,torque = 0, velocity= +0.01, check_flag = False)
                    
                for i in range(7):                        
                    unitree.position_force_velocity_cmd(motor_number = 1,kp = i,kd = 0.1, position = MOTOR1.inital_position_check + 0.33*6.33)
                    unitree2.position_force_velocity_cmd(motor_number = 4 ,kp = i,kd = 0.1, position = MOTOR4.inital_position_check - 0.33*6.33)
                    time.sleep(0.001)
